...
cd C:\Users\abarb\Documents\health\news_underground\mediaSorter\programs\c_prog\mediaSorter\test_audio
...
C:\Users\abarb\Documents\health\news_underground\mediaSorter\programs\c_prog\mediaSorter\x64\Debug\test_audio.exe "[[\"https://example.com/file1\", \"https://example.com/file2\"], [\"https://example.com/file3\"]]"
pause
